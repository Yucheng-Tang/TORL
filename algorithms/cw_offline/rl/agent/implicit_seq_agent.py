...
from algorithms.cw_offline.rl.policy import TanhGaussianPolicy
...
class SeqIQAgent(AbstractAgent):
    def __init__(self,
        ...
        super().__init__(policy, critic, projection,
        ...
        # TODO: load data from offline dataset outside of the agent
    ...
    def step(self):
        ...
        if update_critic_now and buffer_is_ready:
            ...
            update_time = 0
            print("replay buffer is not full! reload dataset please!")
    ...
    def evaluate(self,
                 ...
                 render: bool = False):
        return True
        # TODO: write evaluate using gym and d4rl env
